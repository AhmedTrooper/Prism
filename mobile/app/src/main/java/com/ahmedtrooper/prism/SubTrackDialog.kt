...
import com.ahmedtrooper.prism.databinding.DialogTrackBinding
...
internal typealias Listener = (PrismView.Track, Boolean) -> Unit

internal class SubTrackDialog(private val player: PrismView) {
    private lateinit var binding: DialogTrackBinding

    private var tracks = listOf<PrismView.Track>()
    ...
    class CustomAdapter(private val parent: SubTrackDialog) :
        ...
        class ViewHolder(private val parent: SubTrackDialog, view: View) :
            ...
            fun bind(track: PrismView.Track, checked: Boolean, disabled: Boolean) {
                with (textView) {
                    text = track.name
                    isChecked = checked
                    isEnabled = !disabled
