...
import com.ahmedtrooper.prism.databinding.DialogPlaylistBinding
...
internal class PlaylistDialog(private val player: PrismView) {
    private lateinit var binding: DialogPlaylistBinding

    private var playlist = listOf<PrismView.PlaylistItem>()
    private var selectedIndex = -1

    interface Listeners {
        fun pickFile()
        fun openUrl()
        fun onItemPicked(item: PrismView.PlaylistItem)
    }
    ...
    fun refresh() {
        selectedIndex = PrismLib.getPropertyInt("playlist-pos") ?: -1
    ...
    class CustomAdapter(private val parent: PlaylistDialog) :
        ...
        class ViewHolder(private val parent: PlaylistDialog, view: View) :
            ...
            fun bind(item: PrismView.PlaylistItem, selected: Boolean) {
