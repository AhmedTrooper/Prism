...
import com.ahmedtrooper.prism.filepicker.AbstractFilePickerFragment
...
import com.ahmedtrooper.prism.filepicker.FilePickerFragment
import com.ahmedtrooper.prism.databinding.FragmentFilepickerChoiceBinding
import java.io.File
import java.io.FileFilter

class FilePickerActivity : AppCompatActivity(), AbstractFilePickerFragment.OnFilePickedListener {
    private var fragment: PrismFilePickerFragment? = null
    private var fragment2: PrismDocumentPickerFragment? = null
    ...
    private fun initFilePicker() {
        ...
        if (fragment == null) {
            fragment = PrismFilePickerFragment()
            with (supportFragmentManager.beginTransaction()) {
                setReorderingAllowed(true)
    ...
    private fun initDocPicker(root: Uri) {
        ...
        fragment2 = PrismDocumentPickerFragment(root)
        supportActionBar?.show()
