...
internal object Utils {
    ...
    class AudioMetadata {
        ...
        fun readAll() {
            mediaTitle = PrismLib.getPropertyString("media-title")
        ...
        fun update(property: String): Boolean {
            ...
            if (property == "metadata") {
                ...
                mediaArtist = PrismLib.getPropertyString("metadata/by-key/Artist")
                mediaAlbum = PrismLib.getPropertyString("metadata/by-key/Album")
                return true
            }
            return false
        }
    ...
    // cf. AndroidManifest.xml and PlayerActivity.resolveUri()
    val PROTOCOLS = setOf(
